...
namespace Ui
{
    public class AudioSettings : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_audioMixer.GetFloat("Music", out float volumeMusic) && volumeMusic < 0) _musicToggle.isOn = true;
            if (_audioMixer.GetFloat("Sound", out float volumeSound) && volumeSound < 0) _soundToggle.isOn = true;
        }
